...
########################################################################################################################
    ...
    with open(f'resultados/modelo_2_V1/{periodo}_modelo0_{missing}_OBITO.txt', 'w') as f:
        f.write('---------------------------------------------------------------- \n')
    ...
    odds_ratio.to_csv(f'resultados/modelo_2_V1/{periodo}_modelo0_{missing}_OBITO.csv', decimal=',', sep=';', index=False)
    ...
    plt.savefig(f'resultados/modelo_2_V1/fig1a_{periodo}_modelo0_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    #plt.show()
    #
    ...
    plt.legend(['Control','Treatment'])
    plt.savefig(f'resultados/modelo_2_V1/fig1b_{periodo}_modelo0_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    #plt.show()
    #
    # #spearm
    ...
    plt.savefig(f'resultados/modelo_2_V1/graf_corr_{periodo}_modelo0_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()
########################################################################################################################
    print("""
    ...
    with open(f'resultados/modelo_2_V1/{periodo}_modelo1_{missing}_OBITO.txt', 'w') as f:
        f.write('---------------------------------------------------------------- \n')
        f.write('USING PROPENSITY SCORE TO SELECT/MATCH SAMPLES \n')
        f.write('----------------------------------------------------------------\n')
        f.write('N without missing  :' + str(po) +'\n')
    ...
    odds_ratio.to_csv(f'resultados/modelo_2_V1/{periodo}_modelo1_{missing}_OBITO.csv', decimal=',', sep=';', index=False)

    fig = sns.kdeplot(df_mod.query("ANO==0")["PROPENSITY_SCORE"], bw_adjust=.7, shade=False, color="r")
    fig = sns.kdeplot(df_mod.query("ANO==1")["PROPENSITY_SCORE"], bw_adjust=.7, shade=False, color="b")
    plt.legend(['Control', 'Treatment'])
    plt.savefig(f'resultados/modelo_2_V1/fig1a_{periodo}_modelo1_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()
    #
    fig = sns.kdeplot(psw_base.query("ANO==0")["PROPENSITY_SCORE"], bw_adjust=0.7, shade=False, color="r")
    fig = sns.kdeplot(psw_base.query("ANO==1")["PROPENSITY_SCORE"], bw_adjust=0.7, shade=False, color="b")
    plt.legend(['Control', 'Treatment'])
    plt.savefig(f'resultados/modelo_2_V1/fig1b_{periodo}_modelo1_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()
    #
    # #spearm
    ...
    heatmap = sns.heatmap(psw_base[var_corr].corr(method='spearman'), mask=mask, vmin=-1, vmax=1, annot=True,
                          cmap='BrBG')
    heatmap.set_title('Matrix', fontdict={'fontsize': 18}, pad=16)
    plt.savefig(f'resultados/modelo_2_V1/graf_corr_{periodo}_modelo1_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()
########################################################################################################################
########################################################################################################################
...
########################################################################################################################
    ...
    with open(f'resultados/modelo_2_V1/{periodo}_modelo3_{missing}_OBITO.txt', 'w') as f:
        f.write('---------------------------------------------------------------- \n')
        f.write('USING PROPENSITY SCORE TO SELECT/MATCH SAMPLES \n')
        f.write('----------------------------------------------------------------\n')
        f.write('N without missing  :' + str(po) +'\n')
    ...
    odds_ratio['periodo'] = periodo
    odds_ratio['modelo'] = f'modelo3_{missing}'
    odds_ratio.to_csv(f'resultados/modelo_2_V1/{periodo}_modelo3_{missing}_OBITO.csv', decimal=',', sep=';',
                      index=False)

    fig = sns.kdeplot(df_mod.query("ANO==0")["PROPENSITY_SCORE"], bw_adjust=.7, shade=False, color="r")
    fig = sns.kdeplot(df_mod.query("ANO==1")["PROPENSITY_SCORE"], bw_adjust=.7, shade=False, color="b")
    plt.legend(['Control', 'Treatment'])
    plt.savefig(f'resultados/modelo_2_V1/fig1a_{periodo}_modelo3_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()
    #
    fig = sns.kdeplot(psw_base_balanced.query("ANO==0")["PROPENSITY_SCORE"], bw_adjust=0.7, shade=False, color="r")
    fig = sns.kdeplot(psw_base_balanced.query("ANO==1")["PROPENSITY_SCORE"], bw_adjust=0.7, shade=False, color="b")
    plt.legend(['Control', 'Treatment'])
    plt.savefig(f'resultados/modelo_2_V1/fig1b_{periodo}_modelo3_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()
    #
    # #spearm
    ...
    heatmap = sns.heatmap(psw_base_balanced[var_corr].corr(method='spearman'), mask=mask, vmin=-1, vmax=1, annot=True,
                          cmap='BrBG')
    heatmap.set_title('Matrix', fontdict={'fontsize': 18}, pad=16)
    plt.savefig(f'resultados/modelo_2_V1/graf_corr_{periodo}_modelo3_{missing}_OBITO.png', format='png', dpi=300)
    plt.clf()
    # plt.show()