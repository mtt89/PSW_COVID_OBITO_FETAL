...
lista_periodo = ['2018_2019','2018_2020', '2018_2021', '2018_2022', '2019_2021', '2019_2022'
, '2020_2021', '2020_2022', '2021_2022', '2018_2019_2020', '2018_2019_2021'
, '2018_2019_2022', '2018_2020_2021', '2018_2020_2022', '2018_2021_2022'
, '2019_2020_2021', '2019_2020_2022', '2019_2021_2022', '2020_2021_2022'
, '2018_2019_2020_2021', '2018_2019_2020_2022', '2018_2019_2021_2022'
, '2018_2020_2021_2022', '2019_2020_2021_2022', '2018_2019_2020_2021_2022']
lista_escolaridade = ['Ensino_superior']
lista_erro = []
contador = 1
...
path_ = 'modelo_3_subgrupo_escolaridade'
#-----------------------------------------------------------------------------------------------------------------------
for escolaridade in lista_escolaridade:
    df_escolaridade = df[df['escolaridade_mae'] == escolaridade]
    df_escolaridade = df_escolaridade.reset_index(drop=True)
    for periodo in lista_periodo:
        print(f'{periodo} - {escolaridade} - {modelo} - {missing} - rodada {contador} de {len(lista_periodo) * len(lista_escolaridade)}')
        contador += 1
        try:
            df_ano = filtrar_e_adicionar(df_escolaridade, periodo)
            df_ano['idademae_faixa'] = ['maior_igual_35' if i in(['entre_35_39', 'maior_igual_40']) else i for i in df_ano['idademae_faixa']]
            df_ano['idademae_faixa'] = ['menor_35' if i in (['menor_igual_19', 'entre_20_34']) else i for i in df_ano['idademae_faixa']]
            # Separando df_mod
            variaveis_1 = [
                'ANO'
                , 'evento_REGIAO'
            ...
            with open(f'resultados/{path_}/{periodo}_{modelo}_{missing}_{escolaridade}.txt', 'w') as f:
                f.write('---------------------------------------------------------------- \n')
            ...
            odds_ratio['escolaridade'] = escolaridade
            odds_ratio.to_csv(f'resultados/{path_}/{periodo}_{modelo}_{missing}_{escolaridade}.csv', decimal=',', sep=';',
                              index=False)
            ...
            plt.savefig(f'resultados/{path_}/fig1a_{periodo}_{modelo}_{missing}_{escolaridade}.png', format='png', dpi=300)
            plt.clf()
            # plt.show()
            #
            ...
            plt.legend(['Control', 'Treatment'])
            plt.savefig(f'resultados/{path_}/fig1b_{periodo}_{modelo}_{missing}_{escolaridade}.png', format='png', dpi=300)
            plt.clf()
            # plt.show()
            #
            # #spearm
            ...
            plt.savefig(f'resultados/{path_}/graf_corr_{periodo}_{modelo}_{missing}_{escolaridade}.png', format='png',
                        dpi=300)
            plt.clf()
            # plt.show()
        except:
            lista_erro.append({'periodo': [periodo], 'escolaridade': [escolaridade]})
            continue
...
lista_periodo = ['2018_2019', '2018_2020', '2018_2021', '2018_2022', '2019_2022', '2018_2019_2020'
, '2018_2019_2021', '2018_2019_2022', '2018_2020_2021', '2018_2020_2022'
, '2018_2021_2022', '2019_2020_2022', '2019_2021_2022', '2018_2019_2020_2021'
, '2018_2019_2020_2022', '2018_2019_2021_2022', '2018_2020_2021_2022'
, '2019_2020_2021_2022', '2018_2019_2020_2021_2022']
lista_escolaridade = ['Ensino_medio']
lista_erro = []
contador = 1
...
lista_periodo = ['2021_2022']
lista_escolaridade = ['Sem_escolaridade']
lista_erro = []
contador = 1
