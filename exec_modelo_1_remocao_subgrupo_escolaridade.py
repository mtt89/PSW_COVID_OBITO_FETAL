...
for escolaridade in lista_escolaridade:
    ...
    for periodo in lista_periodo:
        ...
        df_metrics['escolaridade'] = escolaridade
        # Salvar em um arquivo CSV
        df_metrics.to_csv(f'resultados/modelo_3_subgrupo_escolaridade/{periodo}_modelo1_{missing}_{escolaridade}_teste_overfitting.csv', decimal=',', sep=';',
                          index=False)
        ...
        with open(f'resultados/modelo_3_subgrupo_escolaridade/{periodo}_modelo1_{missing}_{escolaridade}_OBITO.txt', 'w') as f:
            f.write('---------------------------------------------------------------- \n')
        ...
        odds_ratio.to_csv(f'resultados/modelo_3_subgrupo_escolaridade/{periodo}_modelo1_{missing}_{escolaridade}_OBITO.csv', decimal=',', sep=';',
                          index=False)
        ...
        plt.savefig(f'resultados/modelo_3_subgrupo_escolaridade/fig1a_{periodo}_modelo1_{missing}_{escolaridade}_OBITO.png', format='png', dpi=300)
        plt.clf()
        # plt.show()
        #
        ...
        plt.legend(['Control', 'Treatment'])
        plt.savefig(f'resultados/modelo_3_subgrupo_escolaridade/fig1b_{periodo}_modelo1_{missing}_{escolaridade}_OBITO.png', format='png', dpi=300)
        plt.clf()
        # plt.show()
        #
        # #spearm
        ...
        plt.savefig(f'resultados/modelo_3_subgrupo_escolaridade/graf_corr_{periodo}_modelo1_{missing}_{escolaridade}_OBITO.png', format='png', dpi=300)
        plt.clf()
        # plt.show()
