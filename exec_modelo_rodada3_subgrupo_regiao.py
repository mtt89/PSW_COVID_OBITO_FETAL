...
for regiao in lista_regiao:
    ...
    for periodo in lista_periodo:
        ...
        try:
            ...
            plt.savefig(f'resultados/{path_}/graf_corr_{periodo}_{modelo}_{missing}_{regiao}.png', format='png', dpi=300)
            plt.clf()
            # plt.show()
        except:
...
lista_erro_.to_csv(f'resultados/{path_}/erro_{modelo}_{missing}_regiao.csv', index=False)
