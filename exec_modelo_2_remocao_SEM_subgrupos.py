...
for periodo in lista_periodo:
    ...
    df_metrics.to_csv(f'resultados/modelo_3_sem_subgrupo/{periodo}_modelo1_{missing}_teste_overfitting.csv',
                      decimal=',', sep=';',
                      index=False)
    ...
    plt.savefig(f'resultados/modelo_3_sem_subgrupo/graf_corr_{periodo}_modelo1_{missing}_OBITO.png', format='png',
                dpi=300)
    plt.clf()
    # plt.show()
