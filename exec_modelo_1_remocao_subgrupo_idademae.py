...
for idade in lista_idade:
    ...
    for periodo in lista_periodo:
        ...
        df_metrics['idademae'] = idade
        # Salvar em um arquivo CSV
        df_metrics.to_csv(f'resultados/modelo_3_subgrupo_idade/{periodo}_modelo1_{missing}_{idade}_teste_overfitting.csv', decimal=',', sep=';',
                          index=False)
        ...
        with open(f'resultados/modelo_3_subgrupo_idade/{periodo}_modelo1_{missing}_{idade}_OBITO.txt', 'w') as f:
            f.write('---------------------------------------------------------------- \n')
        ...
        odds_ratio['idademae'] = idade
        odds_ratio.to_csv(f'resultados/modelo_3_subgrupo_idade/{periodo}_modelo1_{missing}_{idade}_OBITO.csv', decimal=',', sep=';',
                          index=False)
        ...
        plt.savefig(f'resultados/modelo_3_subgrupo_idade/fig1a_{periodo}_modelo1_{missing}_{idade}_OBITO.png', format='png', dpi=300)
        plt.clf()
        # plt.show()
        #
        ...
        plt.legend(['Control', 'Treatment'])
        plt.savefig(f'resultados/modelo_3_subgrupo_idade/fig1b_{periodo}_modelo1_{missing}_{idade}_OBITO.png', format='png', dpi=300)
        plt.clf()
        # plt.show()
        #
        # #spearm
        ...
        plt.savefig(f'resultados/modelo_3_subgrupo_idade/graf_corr_{periodo}_modelo1_{missing}_{idade}_OBITO.png', format='png', dpi=300)
        plt.clf()
        # plt.show()
