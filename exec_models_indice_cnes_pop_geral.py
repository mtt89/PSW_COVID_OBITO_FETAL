...
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'BELEM DE SAO FRANCISCO',  'BELEM DO SAO FRANCISCO', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'SANTA TERESINHA',  'SANTA TEREZINHA', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'MUQUEM DE SAO FRANCISCO',  'MUQUEM DO SAO FRANCISCO', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'POXOREO',  'POXOREU', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'SAO THOME DAS LETRAS',  'SAO TOME DAS LETRAS', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'BRASOPOLIS',  'BRAZOPOLIS', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'SANTO ANTONIO DO LEVERGER',  'SANTO ANTONIO DE LEVERGER', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'ELDORADO DOS CARAJAS',  'ELDORADO DO CARAJAS', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'ELDORADO DOS CARAJAS',  'ELDORADO DO CARAJAS', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'SANTA ISABEL DO PARA',  'SANTA IZABEL DO PARA', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'LAGOA DO ITAENGA',  'LAGOA DE ITAENGA', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'IGUARACI',  'IGUARACY', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'TRAJANO DE MORAIS',  'TRAJANO DE MORAES', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'SAO LUIS DO PARAITINGA',  'SAO LUIZ DO PARAITINGA', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'FLORINIA',  'FLORINEA', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'COUTO DE MAGALHAES',  'COUTO MAGALHAES', df['evento_MUNNOMEX_limpo'])
df['evento_MUNNOMEX_limpo'] = np.where(df['evento_MUNNOMEX_limpo']== 'SAO VALERIO DA NATIVIDADE',  'SAO VALERIO', df['evento_MUNNOMEX_limpo'])

df = df.merge(junta, how='left', left_on=['evento_MUNNOMEX_limpo', 'evento_SIGLA_UF'], right_on=['municipio_limpo', 'UF'])
# Removendo Municípios sem correspondência com a tabela de população.
print(len(df))
df = df[~df['Pop_feminina_entre_10_50_anos_censo_2022'].isnull()]
...
# bb=df.loc[df['evento_MUNNOMEX_limpo'].str.contains( 'SAO DOMINGOS', case=False, na=False), ['evento_MUNNOMEX_limpo',  'evento_SIGLA_UF']]
# bb
# pd.unique(bb['evento_SIGLA_UF'])
